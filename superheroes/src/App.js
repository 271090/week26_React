...
function App() {
  return (
    <div className="container">
      <h1 className="title">База супергероев MARVEL & DC Comics</h1>
      <div className="card-container">
      {
        superheroes.map((card) => 
        <Card name={card.name} photo={card.photo}
        universe={card.universe} alterego={card.alterego} occupation={card.occupation}
        friends={card.friends} superpower={card.superpower}
        more={card.more}></Card>)
      }</div>
    </div>
  );
